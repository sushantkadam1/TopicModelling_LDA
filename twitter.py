...
TIMELINES = True
nFOLLOWERS = '5000'
APP_KEY       = "L4sziHBqV4VUIfKezbos0JMVl"
APP_SECRET    = "lJau6R7GIHFwoGR5wB3PlLQPXBChwzJFJ9WGXXtazcDSA1Vb1X"
ACCESS_TOKEN  = "941359629606539264-05XcmQfdwMXTbPNWS3r7cZThvbQBxCK"
...
op.add_option("-s", "--screen_name",
              dest="screen_name", default=PARENT, type="string",
              help="Screen name of the main account")

op.add_option("-f", "--followers",
              action="store_true", dest="followers", default=FOLLOWERS,
              help="Extracts IDs of screen_name followers from Twitter")

op.add_option("-t", "--timelines",
              action="store_true", dest="timelines", default=TIMELINES,
...
op.add_option("-n", "--n_followers", dest="n_followers", default=nFOLLOWERS,
