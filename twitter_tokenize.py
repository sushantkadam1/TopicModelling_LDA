...
###### CONSTANTS ##########
PARENT = "jeremycorbyn"
dict_filename = PARENT + "_tok.dict"
corpus_filename = PARENT + "_tok.mm"
...
op.add_option("--save_dict", dest="dict_filename", default=dict_filename,
              help="Set to the filename of the Dictionary you want to save")

op.add_option("--save_corpus", dest="corpus_filename", default=corpus_filename,
